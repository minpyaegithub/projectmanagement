...
@section('title','ClientCategory Form')
@section('content')
    <div class="container">
        <div class="well" style="overflow-x:auto;">
            ...
            @endif
                <legend>Client Category Form</legend>
            ...
            <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('member/ccategory/view')}}">
            <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('member/ccategory/delete')}}">
            <input type="hidden" name="hidden_select" id="hidden_select" value="{{url('member/ccategory/select')}}">
            <!-- Add Modal start -->
            <div class="modal fade" id="addModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{url('member/ccategory')}}" method="post">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="control-label col-sm-5">
                                                            <div style="float: left">
                                                                <Label ID="lblCCategoryID">
                                                                    Category ID:
                                                                </Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-7 text-group float-left">
                                                            <input type="text" tabindex="1" id="txtCCategoryID" name="ccategory_id"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="control-label col-sm-5">
                                                            <div style="float: left">
                                                                <Label ID="lblCCategoryName"  Style="width: 100%;">
                                                                    Category Name:
                                                                </Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-7 text-group float-left">
                                                            <input type="text" tabindex="2" id="txtCCategoryName" name="ccategory_name"
                ...
                <div class="modal fade" id="viewModal" role="alert">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><b>Category ID : </b><span id="view_ccategoryid" class="text-success"></span></p>
                                <p><b>Category Name : </b><span id="view_ccategoryname" class="text-success"></span></p>
                            </div>
                            <div class="modal-footer">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
           __dataTable();
            ...
            $("#txtCCategoryID").change(function () {
                var id = $("#txtCCategoryID").val();
                select(id);
            });
        ...
        function clear(){
            __disable(false);
            $("#txtCCategoryID").val('');
            $("#txtCCategoryName").val('');
            $("#txtCCategoryID").focus();
        ...
        function fun_view(id)
        {
            ...
            $.ajax({
                ...
                success: function(result){
                    $("#view_ccategoryid").text(result.ccategory_id);
                    $("#view_ccategoryname").text(result.name);
                }
            });
        }
        ...
        function select(id)
        {
            ...
            $.ajax({
                ...
                data:{"id":id},
                success:function(result){
                    $("#txtCCategoryID").val(result.ccategory_id);
                    $("#txtCCategoryName").val(result.name);
