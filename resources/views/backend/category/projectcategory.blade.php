...
@section('content')
    <div class="container">
        <div class="well" style="overflow-x:auto;">
            ...
            <input type="hidden" name="hidden_view" id="hidden_view" value="{{url('member/pcategory/view')}}">
            <input type="hidden" name="hidden_delete" id="hidden_delete" value="{{url('member/pcategory/delete')}}">
            <input type="hidden" name="hidden_select" id="hidden_select" value="{{url('member/pcategory/select')}}">
            <!-- Add Modal start -->
            <div class="modal fade" id="addModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{url('member/pcategory')}}" method="post">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-sm-7">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="control-label col-sm-5">
                                                            <div style="float: left">
                                                                <Label ID="lblPCategoryID">
                                                                    Category ID:
                                                                </Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-7 text-group float-left">
                                                            <input type="text" tabindex="1" id="txtPCategoryID" name="pcategory_id"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="control-label col-sm-5">
                                                            <div style="float: left">
                                                                <Label ID="lblPCategoryName"  Style="width: 100%;">
                                                                    Category Name:
                                                                </Label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-7 text-group float-left">
                                                            <input type="text" tabindex="2" id="txtPCategoryName" name="pcategory_name"
                ...
                <div class="modal fade" id="viewModal" role="alert">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p><b>Category ID : </b><span id="view_pcategoryid" class="text-success"></span></p>
                                <p><b>Category Name : </b><span id="view_pcategoryname" class="text-success"></span></p>
                            </div>
                            <div class="modal-footer">
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#txtPCategoryID").change(function () {
                var id = $("#txtPCategoryID").val();
                select(id);
            });
        ...
        function clear(){
            __disable(false);
            $("#txtPCategoryID").val('');
            $("#txtPCategoryName").val('');
            $("#txtPCategoryID").focus();
        ...
        function fun_view(id)
        {
            ...
            $.ajax({
                ...
                success: function(result){
                    $("#view_pcategoryid").text(result.pcategory_id);
                    $("#view_pcategoryname").text(result.name);
                }
            });
        }
        ...
        function select(id)
        {
            ...
            $.ajax({
                ...
                data:{"id":id},
                success:function(result){
                    $("#txtPCategoryID").val(result.pcategory_id);
                    $("#txtPCategoryName").val(result.name);
